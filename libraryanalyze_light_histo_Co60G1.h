...
//--------WHAT to generate?-------------
///-------------------------------------
bool fixed_energy = true; double fixedE = 1.173; //MeV
bool supernova = false;
bool solar = false;
bool gen_argon = false;
bool gen_Co60B = false;
bool gen_Co60G1 = true;
...
//-------------------------------------
TFile event_file("event_file_Co60G1_DUNE_tw1.root", "RECREATE", "Event File");
