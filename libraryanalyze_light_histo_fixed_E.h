...
//--------WHAT to generate?-------------
///-------------------------------------
bool fixed_energy = true; double fixedE = 5.6; //MeV
...
//-------------------------------------
TFile event_file("event_file_560KeV_DUNE_tw1_1M_slow_alpha.root", "RECREATE", "Event File");
...
const int max_events_FE = 1000000;
