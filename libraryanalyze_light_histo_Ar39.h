...
bool solar = false;
bool gen_argon = true;//Ar39
bool gen_Co60B = false;
bool gen_Co60G = false;
bool gen_Ar42 = false;
bool gen_40KB = false;
bool gen_40KG = false;
bool gen_Kr85B = false;
bool gen_Kr85G = false;
...
//-------------------------------------
TFile event_file("event_file_Ar42_DUNE_tw1.root", "RECREATE", "Event File");
...
const double Q_Co60B = 0.665;		//End point of beta decay of Co60[MeV]
...
const int max_events_Co60B =1;
const int max_events_Co60G =1;
...
const int max_events_40KB = 1;
const int max_events_40KG = 1;
const int max_events_Kr85B =1;
const int max_events_Kr85G =1;
