...
double PosMax[3] = {3.505e2,600,1395};     //This range is only a plane
...
//-------------------------------------
TFile event_file("event_file_40KB_DUNE_tw1.root", "RECREATE", "Event File");
...
const double Q_40KB = 1.31;		//End point of beta decay of 40K[MeV]
